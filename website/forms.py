...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['username'].help_text='<span class="form_text text-muted"><small>Required. 150 characters or fewer. Letters and @/./+/-/_ only.</small></span>'

        self.fields['password1'].widget.attrs['class']='form-control'
        self.fields['password1'].widget.attrs['placeholder']='Password'
        self.fields['password1'].label=''
        self.fields['password1'].help_text='<ul class="form-text text_muted"><li>Your password must have atleast 8 characters</li><li>Your password cannot be entirely numeric.</li></ul>'

        self.fields['password2'].widget.attrs['class']='form-control'
        self.fields['password2'].widget.attrs['placeholder']='Comfirm Password'
        self.fields['password2'].label=''
        self.fields['password2'].help_text='<span class="form_text text-muted"><small>Enter the same password as before</small></span>'
...
class AddRecordForm(forms.ModelForm):
    ...
    district= forms.CharField(required=True,widget=forms.TextInput(attrs={'class':'form-control','placeholder':'District'}),label="")
